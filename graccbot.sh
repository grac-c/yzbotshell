...
#写入快捷键
    ...
    sed -i -e '1a bash <(curl -sL https://raw.githubusercontent.com/grac-c/yzbotshell/refs/heads/main/u.sh)' /usr/bin/bc
    chmod +x /usr/bin/bc
...
function deletegitplugin()
{
	clear
    cd ~ && cd $yz
    bash <(curl -sL https://raw.githubusercontent.com/grac-c/yzbotshell/refs/heads/main/deletegit.sh)
        PluginIndex
        PluginIndexNum
...
function deletejs()
{
	clear
    cd ~ && cd $yz
    bash <(curl -sL https://raw.githubusercontent.com/grac-c/yzbotshell/refs/heads/main/deletejs.sh)
        PluginIndex
        PluginIndexNum
...
function device()
{
    ...
    cd $yz/data/$QQnumber
    curl -o device-$QQnumber.json https://raw.githubusercontent.com/grac-c/yzbotshell/refs/heads/main/QQrepaire
	echo '已尝试进行修复'
...
{
    echo '正在更新中，请耐心等待'
    curl -sL https://raw.githubusercontent.com/grac-c/yzbotshell/refs/heads/main/pnpm | bash
    echo '已更新完成'
    sleep 2s
	errorlist
	RepaireNum
...
function ffmpeginstall()
{
    ...
    git clone --depth=1 https://github.com/grac-c/ffmpeg.git
...
#下载python3.10.0压缩包
    git clone --depth=1 https://github.com/grac-c/Python3.git
...
if [ $(id -u) == 0 ];then
	...
	if [ $change == 1 ];then
		...
		bash <(curl -sL https://raw.githubusercontent.com/grac-c/yzbotshell/refs/heads/main/graccyz.sh)
    elif [ $change == 3 ];then
		bash <(curl -sL https://raw.githubusercontent.com/grac-c/yzbotshell/refs/heads/main/graccmyz.sh)
    else
