...
```
 curl -sL https://raw.githubusercontent.com/grac-c/yzbotshell/refs/heads/main/u.sh | bash
```
...
```
bash <(curl -sL https://raw.githubusercontent.com/grac-c/yzbotshell/refs/heads/main/graccbot.sh)
```
